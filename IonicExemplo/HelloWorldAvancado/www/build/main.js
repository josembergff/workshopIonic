...
DetalheClienteComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
        selector: 'app-detalhe-cliente',template:/*ion-inline-start:"C:\Fonte\workshopIonic\IonicExemplo\HelloWorldAvancado\src\pages\cliente\detalhe-cliente\detalhe-cliente.component.html"*/'<ion-header>\n\n    <ion-navbar color="primary">\n\n        <ion-buttons left>\n\n            <button ion-button icon-only (click)="fechar()">\n\n            <ion-icon name="arrow-round-back"></ion-icon>\n\n      </button>\n\n        </ion-buttons>\n\n        <ion-title>Detalhes do cliente</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="padding">\n\n\n\n    <ion-list>\n\n        <ion-item> {{clienteAtual?.Nome}}</ion-item>\n\n        <ion-item> {{clienteAtual?.Sobrenome}}</ion-item>\n\n        <ion-item> {{clienteAtual?.DataCriacao | date}}</ion-item>\n\n\n\n        <ion-item> <button ion-button color="danger" (click)="excluir($event)">Remover</button></ion-item>\n\n    </ion-list>\n\n</ion-content>'/*ion-inline-end:"C:\Fonte\workshopIonic\IonicExemplo\HelloWorldAvancado\src\pages\cliente\detalhe-cliente\detalhe-cliente.component.html"*/
    }),
...
HomePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home',template:/*ion-inline-start:"C:\Fonte\workshopIonic\IonicExemplo\HelloWorldAvancado\src\pages\home\home.html"*/'<ion-header>\n\n    <ion-navbar color="primary">\n\n        <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n        <ion-title>Inicio</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    <h3>Aplicativo workshop Autotrac</h3>\n\n    <ion-refresher (ionRefresh)="atualizarLocalizacao($event)">\n\n        buscando localização...\n\n    </ion-refresher>\n\n    <ion-list>\n\n        <ion-item>Latitude: {{latitude}}</ion-item>\n\n        <ion-item>Longitude: {{longitude}}</ion-item>\n\n    </ion-list>\n\n\n\n</ion-content>'/*ion-inline-end:"C:\Fonte\workshopIonic\IonicExemplo\HelloWorldAvancado\src\pages\home\home.html"*/
    }),
    ...
    FiltroTabelaPipe.prototype.transform = function (lista, filtroGeral) {
        ...
        if (filtroGeral && filtroGeral.length > 0) {
            ...
            retorno = retorno.filter(function (item) { return item.Nome.toLowerCase().indexOf(filtroRecebido_1) >= 0
                || item.Sobrenome ? item.Sobrenome.toLowerCase().indexOf(filtroRecebido_1) >= 0 : false
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\Fonte\workshopIonic\IonicExemplo\HelloWorldAvancado\src\app\app.html"*/'<ion-menu [content]="content">\n\n    <ion-header>\n\n        <ion-toolbar color="primary">\n\n            <ion-title>Menu</ion-title>\n\n        </ion-toolbar>\n\n    </ion-header>\n\n\n\n    <ion-content>\n\n        <ion-list>\n\n            <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n        {{p.title}}\n\n      </button>\n\n        </ion-list>\n\n    </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\Fonte\workshopIonic\IonicExemplo\HelloWorldAvancado\src\app\app.html"*/
    }),
